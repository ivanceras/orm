...
/**
 * Will be inherited from a generated class from {@link DAOGenerator#generateModelMetaData}
 * This is only useful for GWT classes, since GWT doesn't support reflection, we will have to make a way to create
